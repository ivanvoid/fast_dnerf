...
def train():
    ...
    # CREATE NERF MODEL
    kwargs_train = create_nerf(args, device)

    optimizer = kwargs_train['optimizer']
    start = kwargs_train['start']
    global_step = start
    render_kwargs_train = kwargs_train['render_kwargs_train']
    render_kwargs_test = kwargs_train['render_kwargs_test']
    ...
    kwargs_train['render_kwargs_train'].update(bds_dict)
    kwargs_train['render_kwargs_test'].update(bds_dict)
